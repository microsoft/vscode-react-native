...
export class ExponentHelper {
    ...
    public createExpJson(): Q.Promise<void> {
        ...
        return this.readVscodeExponentSettingFile()
            .then(exponentJson => {
                if (exponentJson.createOrOverrideExpJson) {
...
// Please do not modify it manually. All changes will be lost.\n`;
     ...
     */
    private get exponentSdk(): Q.Promise<string> {
     ...
     * e.g. index.ios.js
     */
    private get entrypoint(): Q.Promise<string> {
     ...
     */
    private get entrypointComponent(): Q.Promise<string> {
