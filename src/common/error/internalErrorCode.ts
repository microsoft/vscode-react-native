...
export enum InternalErrorCode {
    ...
    FailedToRunOnMacOS = 116,
    DebuggingCommandFailed = 117,
    FailedToTestDevEnvironment = 118,
    CommandCanceled = 119,
    FailedToConfigEASBuild = 120,
    FailedToOpenProjectPage = 121,
    FailedToRevertOpenModule = 122,
    FailedToOpenRNUpgradeHelper = 123,
    FailedToInstallExpoGo = 124,
    FailedToLaunchExpoWeb = 125,
    FailedToRunRNDoctor = 126,
    FailedToRunExpoDoctor = 127,
    FailedToRunPrebuild = 128,
    FailedToRunPrebuildClean = 129,
    FailedToReopenQRCode = 130,
    FailedToEnableHermes = 131,
