...
export class Packager {
    ...
    public getPackagerArgs(rnVersion: string, resetCache = false): Promise<string[]> {
    ...
    public start(resetCache = false): Promise<void> {
    ...
    public stop(silent = false): Promise<any> {
    ...
    private killPackagerProcess(): Promise<void> {
        ...
        return new CommandExecutor(this.projectPath, this.logger)
            ...
            .then(() => {
                ...
                const helper = new ExponentHelper(this.workspacePath, this.projectPath);
