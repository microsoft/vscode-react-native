...
export const DEBUG_CONFIGURATION_NAMES = {
    ...
    DEBUG_DIRECT_IN_EXPONENT: "Debug direct in Exponent",
...
export const debugConfigurations: Record<string, vscode.DebugConfiguration> = {
    ...
    [DEBUG_CONFIGURATION_NAMES.DEBUG_DIRECT_IN_EXPONENT]: {
        name: DEBUG_CONFIGURATION_NAMES.DEBUG_DIRECT_IN_EXPONENT,
        cwd: "${workspaceFolder}",
        type: DEBUG_TYPES.REACT_NATIVE_DIRECT,
        request: "launch",
        platform: PlatformType.Exponent,
