...
function registerReactNativeCommands(context: vscode.ExtensionContext): void {
    ...
    registerVSCodeCommand(context, "runInspector", ErrorHelper.getInternalError(InternalErrorCode.CommandFailed, "React Native: Element Inspector"), () => CommandPaletteHandler.runInspector());
}
