...
function registerReactNativeCommands(context: vscode.ExtensionContext): void {
    ...
    registerVSCodeCommand(context, "runInspector", ErrorHelper.getInternalError(InternalErrorCode.CommandFailed, "React Native: Run React Element Inspector"), () => CommandPaletteHandler.runInspector());
}
