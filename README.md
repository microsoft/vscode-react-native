...
This is a preview version of the refactored React Native Tools extension. It's not recommended to use the preview version and the legacy one at the same time.
