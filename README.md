...
|`expoConnectionType`|The connection type to be used on Expo debugging to communicate with a device or an emulator. Possible values: `tunnel`, `lan`, `local`|`string`|`tunnel`|
