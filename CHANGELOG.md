...
* Values in the `target` debug scenario argument are no longer replaced by UDID in cases the existing simulator name is already used there [#1431](https://github.com/microsoft/vscode-react-native/pull/1431)
