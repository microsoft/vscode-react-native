...
* Fixed launch of iOS apps where the names of the project and the app bundle are not the same [#1213](https://github.com/microsoft/vscode-react-native/pull/1213)
