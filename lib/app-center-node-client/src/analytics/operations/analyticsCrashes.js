 ...
 */
function _listsessionlogs(appName, crashId, ownerName, options, callback) {
...
/** Class representing a AnalyticsCrashes. */
class AnalyticsCrashes {
  /**
   * Create a AnalyticsCrashes.
   ...
   */
  listsessionlogsWithHttpOperationResponse(appName, crashId, ownerName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listsessionlogs(appName, crashId, ownerName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listsessionlogs(appName, crashId, ownerName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._listsessionlogs(appName, crashId, ownerName, options, optionalCallback);
    }
  }

}

module.exports = AnalyticsCrashes;
