...
declare class DistributeClient extends ServiceClient {
  /**
   * @class
   * Initializes a new instance of the DistributeClient class.
   * @constructor
   *
  ...
  distributeAnalytics: operations.DistributeAnalytics;
  distributeApps: operations.DistributeApps;
}

export = DistributeClient;
