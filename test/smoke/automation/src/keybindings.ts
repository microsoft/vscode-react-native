...
export class KeybindingsEditor {
    ...
    public async updateKeybinding(
        ...
        await this.code.waitAndClick(
            ".keybindings-list-container .monaco-list-row.keybinding-item",
        );
        await this.code.waitForElement(
            ".keybindings-list-container .monaco-list-row.keybinding-item.focused.selected",
        );

        await this.code.waitAndClick(
            ".keybindings-list-container .monaco-list-row.keybinding-item .action-item .codicon.codicon-add",
        );
        ...
        await this.code.waitForElement(
            `.keybindings-list-container .keybinding-label div[title="${title}"]`,
        );
    }
}
