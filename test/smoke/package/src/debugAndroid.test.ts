...
import { sleep, waitUntilLaunchScenarioTargetUpdate } from "./helpers/utilities";
import { SmokeTestsConstants } from "./helpers/smokeTestsConstants";
import { pureRNWorkspacePath, RNworkspacePath, runVSCode } from "./main";
...
export function setup(testParameters?: TestRunArguments) {
    ...
    describe("Debugging Android", () => {
        ...
        it("RN Android emulator save test", async function () {
            ...
            AndroidEmulatorHelper.runAndroidEmulator();
            await AndroidEmulatorHelper.waitUntilEmulatorStarting();
            console.log("Android emulator save test: Android emulator started 1");
            await sleep(5000);
            console.log("Android emulator save test: Terminating Android emulator");
            AndroidEmulatorHelper.terminateAndroidEmulator();
            await AndroidEmulatorHelper.waitUntilAndroidEmulatorTerminating();
            ...
            await AndroidEmulatorHelper.waitUntilEmulatorStarting();
            console.log("Android emulator save test: Android emulator started 2");
