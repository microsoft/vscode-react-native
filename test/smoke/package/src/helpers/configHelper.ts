...
export class TestConfigurator {
    ...
    public static verifyEnvVariables(variables: TestEnvVariables) {
        ...
        if (!variables.EXPO_SDK_MINOR_VERSION) {
            console.warn("Optional EXPO_SDK_MINOR_VERSION variable is not set. Use latest.");
        }
    ...
    public static setUpEnvVariables(envConfigFilePath: string) {
        ...
        if (variables.EXPO_SDK_MINOR_VERSION === "skip") {
            delete variables.EXPO_SDK_MINOR_VERSION;
        }
    ...
    public static printEnvVariableConfiguration() {
        ...
        initLog += `EXPO_SDK_MINOR_VERSION = ${process.env.EXPO_SDK_MINOR_VERSION}\n`;
