...
suite("sourceMap", function () {
    ...
    test("should ignore sourcemap urls in JavaScript objects and strings", function () {
        const expectedUrlHref = "http://localhost:8081/index.map?platform=android&dev=true";
        const sourceMap = new SourceMapUtil();

        const testFunction = (scriptBody: string, expectedResult: string) => {
            const matchResult = (<any>sourceMap).searchSourceMapURL(scriptBody);
            assert.strictEqual(expectedResult, matchResult && matchResult[2]);
        };

        testFunction(
            'var myTest = "\\n//# sourceMappingURL=test.min.js.map\\n\\n//# sourceMappingURL=test.min.js.map\\n\\n";\n' +
                "//# sourceMappingURL=http://localhost:8081/index.map?platform=android&dev=true",
            expectedUrlHref,
        );

        testFunction(
            "  var test_js = function test_js(cdn) {\n" +
    ...
    test("should return correct sourcemap url for RN macOS", function () {
        ...
        const scriptBody =
            "//# sourceMappingURL=//localhost:8081/index.map?platform=macos&dev=true";
