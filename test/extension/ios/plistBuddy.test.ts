...
suite("plistBuddy", function() {
    suite("extensionContext", function() {
        ...
        test("getBundleId should return the bundle ID for RN <0.59", function() {
            ...
            sandbox.stub(ReactNativeProjectHelper, "getReactNativeVersions").returns(Q.resolve({["react-native"]: "0.58.5"}));
        ...
        test("getBundleId should return the bundle ID for RN >=0.59", function() {
            ...
            sandbox.stub(ReactNativeProjectHelper, "getReactNativeVersions").returns(Q.resolve({["react-native"]: "0.59.0"}));
